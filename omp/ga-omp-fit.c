...
{
    FP fit, sum=0.0, inner_sum;
    FP inner1, inner2;
    FP inner1_sq, inner2_sq;
    int k, i, j;

    FP * sums = calloc(n, sizeof(FP));

    #pragma omp parallel default(none) shared(sums, individual, n, beta)\
         private(k,i,j,inner_sum,inner1,inner2,inner1_sq,inner2_sq)
    {
...
FP fitness_B(int * individual)
{
    ...
    #pragma omp parallel default(none) shared(sums, individual, beta, n)\
         private(k,i,j,inner_sum,inner1,inner2,inner1_sq,inner2_sq)
    {
